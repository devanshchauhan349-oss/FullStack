...
// Create sample resources with ACTUAL file paths for download
resources.push(
    {
        id: 1,
...
const JWT_SECRET = 'edushare_secret_key_2024';
...
app.get('/api/test', (req, res) => {
    res.json({ 
        ...
        users: users.length,
        uploadsFolder: uploadDir,
        sampleFileExists: fs.existsSync(samplePdfPath)
    });
});

const PORT = 5000;
app.listen(PORT, () => {
    console.log(`\n✅ EduShare Backend Running on http://localhost:${PORT}`);
    ...
    console.log(`📄 Sample file created: ${samplePdfPath}\n`);
});